...
<li class="navbar_item"><a href="admin.php" class="naav_link">Admin</a></li>
      ...
      <div class="mainpage">
          ...
          <img src="large.png" height="60" align="right">
    <h2>Register here: </h2>
...
$sql = "INSERT INTO register (company_name, medicine_name,details,region, contact) VALUES ('$company_name', '$medicine_name', '$details', '$region', '$contact')";
